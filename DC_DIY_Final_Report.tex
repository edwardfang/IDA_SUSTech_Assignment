...
\item Can the overrall stasfications be roughly predicted using other attributes of data?
\item What is the most crucial factors that influence the price and overroll satisfaction among the attributes we have?
...
\begin{figure}[htbp]
\centering
\includegraphics[width = \textwidth]{images/price-distr.png}
...
\subsubsection{Label of Overroll Satisfaction}
